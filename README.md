...
- JWT authentication + Google OAuth integration with email verification
- Stripe payment processing for user donations
- Full production deployment with CORS configuration and SSL database connections
...
- AI-powered **cover letter generation** by extracting job details directly from a URL
...
**Open to internship opportunities for Summer 2026 — let's build something great together.**
